...
//If the "new" submit button is selected (in conditional looking for matches below), this will insert a new row into subject and then an associating row to connect it to the article
	...
	if (isset($_POST['new'])) {
		...
		$subj = $dbc->prepare("insert into subject (subject_id, subject_name, type_code) values (null, ?, 'RG')");
...
<!DOCTYPE html>
	<html>
	<head>
	<title><?php echo $pubtitle; ?> - Manage Subjects</title>
...
?>		
	<div class="left">
		<h3>Current Subjects for "<a href="article_admin.php?article_id=<?php echo $article_id. '">'. $article_title;?> </a>"</h3>
